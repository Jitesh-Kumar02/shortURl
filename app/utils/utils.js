...
utils.updateBallsRunsWicketsBowler = async (findById, collection, teamNo, playerId, ballsBowled, runs, wickets) => {
    try {
...
utils.updateBallsRunsBatsman = async (findById, collection, teamNo, playerId, ballsFaced, playerRuns) => {
    try {
...
utils.updateWicketsBatsman = async (findById, collection, teamNo, playerId, flag) => {
    try {
...
utils.updateTeamFallOfWickets = async (findById, collection, teamNo, wicketPlayerId, flag) => {
    try {
        if(flag) {
...
// update team runs
utils.updateTeamRuns = async (findById, collection, teamNo, runs, multiply) => {
    try {
...
utils.updateBall = async (findById, collection, scoreCardTeam, ballId, change) => {
    try {
